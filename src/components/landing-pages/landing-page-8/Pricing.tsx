...
export default function Pricing() {
  return (
    <div
      ...
      className='bg-black bg-gradient-to-b to-[#090A18] to-80% from-[#5D67B360] flex flex-col md:gap-20 gap-10 items-center md:py-32 py-24 text-white'>
        ...
        {pricingDetails.map((plans) => {
          return (
            <div
              ...
              <div className='card flex flex-col gap-16 md:p-6 p-3  justify-start items-start bg-[#151627] rounded-2xl md:pt-12 pt-6 h-fit w-90  m-px '>
                <div className='flex flex-col md:gap-8 gap-6'>
                  <div className='flex flex-col gap-3'>
                    <h3 className='md:text-lg font-semibold'>{plans.title}</h3>
                    <div className='flex items-center'>
                      <span className='md:text-4xl font-semibold text-2xl'>{plans.price}</span>
                  ...
                  <div className='flex flex-col md:gap-4 gap-3'>
                    {plans.features.map((feat) => {
                      return (
                        <div key={feat} className='flex gap-3 text-start'>
