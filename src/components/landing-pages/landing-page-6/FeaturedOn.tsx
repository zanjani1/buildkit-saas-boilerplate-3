...
export default async function FeaturedOn() {
  ...
  return (
    <div className='flex justify-center flex-col items-center md:text-lg text-base md:gap-8 gap-4 md:py-20 py-16 bg-gradient-to-r from-[#090A1833] to-[#313B8233]'>
      <p className=' font-medium text-center text-[#787878] md:text-lg'>
