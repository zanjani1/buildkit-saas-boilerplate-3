import { Lightning } from '@/assets/landing-page-7/icons';
...
export default async function Features2() {
  return (
    <div className='flex flex-col md:py-32 py-16 items-center md:gap-20 gap-10'>
      ...
      <div className='flex md:grid grid-cols-3 flex-col justify-center md:gap-12 gap-4 flex-wrap'>
        {cardDetails.map((card, index) => {
          return (
            <div key={index} className='flex flex-col gap-6  w-96 items-center'>
