    ...
    <div id='features' className='mx-auto px-4 my-[120px]'>
      <div className='max-w-6xl flex flex-col justify-center items-center mx-auto space-y-16 md:space-y-20'>
        <div className='text-center'>
          ...
          <p className='font-medium max-w-sm leading-[38px] text-lp7-secondary tracking-[-1.68px] text-2xl sm:text-[32px]'>
            Essentially, everything you need to ship you first AI App
          </p>
        </div>

        <div className='grid grid-cols-1 mx-auto md:grid-cols-2 xl:grid-cols-3 md:gap-6'>
          {cardContent.map((item, index) => (
            <div key={index} className='rounded-[8px] md:max-w-[308px] bg-[#FAFAFA] p-6'>
              <div>
                <item.icon />
              </div>
              <div className='mt-4'>
