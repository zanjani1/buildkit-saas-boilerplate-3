  ...
  return (
    <div id='#product' className='flex flex-col items-center md:px-0 px-4 pb-0'>
      <div className='flex flex-col gap-8 items-center text-center md:px-0 px-3 md:pt-6'>
        <h1 className='font-medium md:text-5xl text-3xl md:w-[599px] md:h-28 text-center tracking-tighter md:leading-[56.25px] my-3'>
      ...
      <div className='md:pt-20 pt-10'>
        <Image src={hero} width={1028} height={588} alt='hero' className=' rounded-xl' />
      </div>
    </div>
  );
}
