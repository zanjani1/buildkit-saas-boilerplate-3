...
export default function Navbar() {
  return (
    <div className='md:max-w-[397px] md:max-h-20 text-black justify-between w-full flex gap-2 px-4 md:px-0'>
      ...
      <div className='md:flex hidden md:w-72 md:h-10 py-1 px-3 items-center justify-between bg-neutral-100 rounded-3xl gap-20'>
        <div className='flex justify-between items-center gap-1 md:w-64 md:h-8'>
