...
export default async function Pricing() {
  return (
    <div id='pricing' className='max-w-6xl mx-auto px-4 md:py-28 py-12 gap-20 mt-10 md:mt-0'>
      <div className='flex flex-col items-center justify-center gap-10'>
        <div className='flex flex-col justify-center items-center text-center max-w-2xl gap-7'>
          ...
          <p className='max-w-xl text-zinc-950/60 mt-2 font-medium leading-[25.6px]'>
