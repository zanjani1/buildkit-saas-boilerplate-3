  ...
  return (
    <div className='flex justify-center md:py-32 py-10 max-h-[619px] gap-8 relative px-4'>
      <div className='bg-neutral-100 rounded-3xl p-10 max-w-[630px] w-full text-center gap-3'>
        <p className='text-sm text-[#151718] mb-2 font-semibold leading-6'>Subscribe</p>
        <div className='grid grid-cols-1 max-w-xl max-h-64 gap-10 items-center justify-center'>
          ...
          <div className='flex md:max-w-md mx-auto items-center relative'>
            ...
            <div className='absolute md:-right-[65px] -right-[55px] top-full md:-translate-y-[60%] -translate-y-[50%]'>
              <svg
                width='50'
                height='120'
                viewBox='0 0 50 60'
                ...
                className='md:rotate-[-22deg] rotate-[-1deg] h-22'>
                <path
          ...
          <p className='md:text-base text-sm text-zinc-600 max-w-[550px] '>
