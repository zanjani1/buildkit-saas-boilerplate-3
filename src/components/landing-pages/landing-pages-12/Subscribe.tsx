  ...
  return (
    <div className='flex justify-center md:py-32 py-10 max-h-[619px] gap-8 relative px-4'>
      <div className='bg-neutral-100 rounded-3xl p-10 max-w-[630px] w-full text-center gap-3'>
        <p className='text-sm text-slate-950 mb-2 font-bold leading-6'>Subscribe</p>
        <div className='grid grid-cols-1 max-w-xl max-h-64 gap-10 items-center justify-center'>
          <h2 className='md:text-4xl flex flex-col gap-1 text-2xl font-medium text-center text-slate-950'>
            <span>Join over 1 million</span>
            <span>developers and designers</span>
          </h2>
          <div className='flex md:max-w-md mx-auto items-center relative'>
            <form onSubmit={handleSubmit} className='flex'>
              <Input
                ...
                className='rounded-l-2xl rounded-r-none p-4 gap-3 w-44 h-10 md:w-80 md:h-14 md:text-base'
              />
              <button
                type='submit'
                className={cn(
                  'md:px-6 md:py-2 bg-stone-900 text-white font-medium rounded-r-2xl md:w-[154px] md:h-[56px] text-[10px] md:text-base w-24 h-10',
                  'hover:bg-stone-900/90 transition-colors duration-200'
                )}>
                Subscribe
              </button>
            </form>
            <div className='absolute md:-right-[80px] -right-[55px] top-full md:-translate-y-[55%] -translate-y-[50%]'>
              <svg
                width='50'
                height='120'
                viewBox='0 0 50 60'
                ...
                className='md:rotate-[-1deg] rotate-[-1deg] h-22'>
                <path
